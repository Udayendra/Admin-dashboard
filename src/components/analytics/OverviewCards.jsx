...
const overviewData = [
    { name: "Revenue", value: "$1,567,890", change: 10.8, icon: DollarSign },
    { name: "Users", value: "50,123", change: 9.7, icon: Users },
    { name: "Orders", value: "11,345", change: -4.5, icon: ShoppingBag },
    { name: "Page Views", value: "1,567,890", change: 20.1, icon: Eye },
];
